...
export default function HomePage() {
  ...
  const featuredTextiles = [
    ...
    },
    {
      ...
      image:
        "https://static.wixstatic.com/media/229a21_1c04470654db4ba49f18f46e497ad460~mv2.jpg",
  ...
  return (
    <>
      {/* Public navbar ONLY for public home */}
        ...
        <section id="home" className="hero-section">
          <div className="hero-overlay">
            <div className="hero-content">
              ...
              <p>
                From Kanchipuram silks to Banarasi brocades, discover, shop,
                and manage your textile collections seamlessly.
              </p>

              <Link
                to={auth.currentUser ? "/user/products" : "/login"}
                className="hero-btn"
              >
                Browse Textiles
              </Link>
        ...
        <section id="faq" className="faq-section">
          ...
          <div className="faq-container">
            ...
            <div className="faq-card">
              ...
              <p>
                Browse the featured textiles, add items to your cart,
                and complete checkout easily.
              </p>
            </div>

            <div className="faq-card">
              <h3>Do you deliver nationwide?</h3>
              <p>Yes, we deliver authentic Indian textiles across India.</p>
            </div>

            <div className="faq-card">
              <h3>Are the textiles authentic?</h3>
              <p>
                All products are sourced directly from certified artisans
